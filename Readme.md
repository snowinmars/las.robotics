...
Далее, робототехника - это минимум два разных кружка: по роботам (физике) и технике (логике).
...
Отдельно отмечу, что здесь нет цели "подготовиться к экзаменам". Ничего из нижеперечисленного не поможет получить хорошие оценки ни в учёбе, ни на экзамене.
...
- Подготовка к работе в радиофизике и IT.
    ...
    Эту цель нельзя измерить непосредственно ни в количестве, ни в качестве. Единственное, как я могу предложить оценить полезность курса - это отзывы от учеников, поступивших на работу по указанным специальностям.
