...
Все темы будут затронуты кратко. С одной стороны, я не хочу закапываться в протоколы по уши; с другой - разработка систем без передачи данных между клиентом и сервером невозможна.

#### Цель
- Понять основы межсерверного взаимодействия.
- Понять (де)сериализацию.
