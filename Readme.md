...
Отдельно отмечу, что здесь нет подготовки к экзаменам. Ничего из нижеперечисленного не поможет получить хорошие оценки ни в учёбе, ни на экзамене.
...
- Подготовка к работе в радиофизике и IT.
    ...
    Для радиофизики - это навыки пайки, 3D моделирования и работы с измерительными приборами.
...
Получить от fake api данные.

###### [http_post]

Записать в fake api данные.
