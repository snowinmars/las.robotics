...
1. Как читать этот текст без боли. Этот текст написан в Markdown. Вставьте его слева в [dillinger.io](https://dillinger.io/) - и у вас справа отрисуется красивая статья. Приучайте себя все свои работы оформлять хотя бы в Markdown.
...
- Увеличить массу Фобоса в два раза.
