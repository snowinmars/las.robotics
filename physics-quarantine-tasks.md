...
1. Одна группа берёт только одно задание на неделю.
...
*Недельная норма с человека*: 10 любых задач из 3800.
...
# Объяснения на пальцах <a name="why" />

Объяснить все физические опыты в [видео](https://www.youtube.com/watch?v=Q3oItpVa9fs), а именно
- 0:39 - фигуры Хланди
- 1:00 - speaker dish experiment
- 1:20 - стобоскоп
- со второй половины - катушки Тесла
- 3:32 - труба Рубенса
- 4:57 - почему молния перескакивает на огонь?
- всё остальное по мелочи

К сожалению, аналогов предложить не могу. Я знаю песенки примерно о науке - [Phi](https://www.youtube.com/watch?v=nBgQPSUTWVM) и [Lateralus](https://www.youtube.com/watch?v=XhjspP_xMWE), но там нечего объяснять - только смотреть.
...
**Игры пока отложены из-за больших временных трат на прохождение**
...
*Недельная норма с группы*: одна лабораторка.
...
*Недельная норма с группы*: разбор одного видео.
